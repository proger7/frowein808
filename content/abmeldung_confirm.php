...
$SPRACHE = $LANG["language"]["shortname"];
	...
	if(isset($content[1])){
		if ($SPRACHE == "de"){
			...
			$language_id = 2;
			$user_titel = $_POST['gender-newsletter'];
			$user_anrede = "";
		}
	 
		 
		$user_data = $DB->query_fetch("SELECT * FROM newsletter_users WHERE kundennummer = 0 AND id=".$content[2]);
		if(!empty($user_data)){

		 //$DB->query("DELETE FROM newsletter_users WHERE kundennummer = 0 AND status=1 AND id ='".$content[2]."'");
		 $DB->query("update newsletter_users  set   if_unsubscribe = 1 , status = 0  , `unsubscribe_date` = now()  WHERE kundennummer = 0 AND id ='".$content[2]."'");
		...
		<html>
		  ...
		  <body>
		              ...
		              <tr>
		                <td class="wrapper" colspan="3">
		                  <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="background-color: #f2f2f2;padding: 24px">
		                    <tr>
		                      <td>
		                        <p class="mail__text">Hiermit bestätigen wir Ihnen die erfolgreiche Abmeldung unseres Frowein Newsletters.</p>
		                        <p class="mail__text">Ihre E-Mail Adresse wurde aus dem Verteiler genommen. </p>
		                        <p class="mail__text">Für Fragen zu diesem Newsletter wenden Sie sich bitte an: <a href="mailto:newsletter@frowein808">newsletter@frowein808</a>.Falls Sie diese E-Mail versehentlich erhalten haben, löschen Sie sie einfach.</p>
			...
			// $message = '
			// Guten Tag,<br /><br />
			// hiermit best&auml;tigen wir Ihnen die erfolgreiche Abmeldung unseres Frowein Newsletters.<br /><br /> 
			// Ihre E-Mail Adresse wurde aus dem Verteiler genommen.
			// <br /><br /><br />
			
			// <img src="https://www.frowein808.de/images/Frowein_Biozide_Logo.jpg" width="80" alt="Frowein808" /><br /><br />
			...
			// +49 7432 956-0<br />
			// +49 7432 956-138<br />
			// <a href="mailto:info@frowein808.de">info@frowein808.de</a><br /><br />
			// ';

			
			$subject ='=?UTF-8?B?'.base64_encode("Frowein Newsletter Abmeldung"). "?=";
		}
        else {
		...
		<html>
		  ...
		  <body>
		              ...
		              <tr>
		                <td class="wrapper" colspan="3">
		                  <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="background-color: #f2f2f2;padding: 24px">
		                    <tr>
		                      <td>
		                        <p class="mail__text">We hereby confirm that you have successfully unsubscribed from our Frowein newsletter.</p>
		                        <p class="mail__text">Your email address has been removed from the mailing list.</p>
		                        <p class="mail__text">For questions about this newsletter, please contact: <a href="mailto:newsletter@frowein808">newsletter@frowein808</a>. If you have received this email by mistake, simply delete it.</p>
		                        <p class="mail__text">Kind regards</p>
		                      </td>
		                    </tr>
			...
			// $message = '
			// Hello,<br /><br />
			// Hereby we confirm the successful cancellation of our Frowein Newsletter.<br /><br />
			// Your e-mail address has been taken from the mailing list.
			// <br /><br /><br />

			// <img src="https://www.frowein808.de/images/Frowein_Biozide_Logo.jpg" width="65" alt="Frowein808" /><br /><br />
			...
			$subject ='=?UTF-8?B?'.base64_encode("Frowein Newsletter Unsubscribe"). "?=";
		}
		...
		$mes = 'Anrede: '.$user_data['user_anrede'].'<br />Titel: '.$user_data['user_titel'].'<br />Nachname: '.$user_data['user_nachname'].'<br />Name:'.$user_data['user_name'].'<br />E-Mail: '.$user_data['user_email'];

		//mail('info@frowein808.de','Kopie: Abmeldung zum Newsletter',$mes,$headers);
	...
	if ($SPRACHE == "de"){
		$title = "Abmelden";
		$html .='<h2>Vielen Dank für die Bestätigung. Ihre E-Mail-Adresse wurde aus der Mailingliste rausgenommen.</h2>';
	} else {
		$title = "Unsubscribe";
		$html .='<h2>Thank you for the confirmation. Your e-mail address has been taken out of the mailing list.</h2>';
	}
